...
function Emploi_formateur() {
  ...
  // Function to handle downloading the schedule as a JSON file
  const downloadSchedule = () => {
    const scheduleBlob = new Blob([JSON.stringify(schedule, null, 2)], {
      type: 'application/json',
    });
    const link = document.createElement('a');
    link.href = URL.createObjectURL(scheduleBlob);
    link.download = 'emploi_formateur_schedule.json';
    link.click();
  };
  ...
  return (
    <div>
      ...
      {/* Download Button */}
      <button className="btn btn-success" onClick={downloadSchedule}>
